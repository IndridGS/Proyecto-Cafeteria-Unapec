...
//     getAll: (callback) => {
//         const query = `
//             SELECT v.id, v.no_factura, e.nombre AS empleado, a.description AS articulo, u.nombre AS usuario, v.fecha_venta, v.monto, v.unidades_vendidas, v.comentario, v.estado
//             FROM Ventas v
